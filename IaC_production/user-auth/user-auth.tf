...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn = "arn:aws:execute-api:ap-northeast-2:758733530144:${aws_api_gateway_rest_api.example.id}/*/*${aws_api_gateway_resource.example.path}"
}